...
shinyUI(fluidPage(
  ...
  titlePanel("Hypothesis Test (One Tailed T-test)"),
  br(),
  br(),
  br(),
  ...
  sidebarPanel(
    ...
    conditionalPanel(condition = "$('li.active a').first().html()==='Contact Us'",
  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel('Contact Us',
               h4("Dhruv Dasadia"),
               h6("Email Id: dasadiadhruv2000@gmail.com"),
